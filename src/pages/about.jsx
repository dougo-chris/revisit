...
import { LinkedInIcon, TwitterIcon, MailIcon } from '@/components/Icons'
...
function SocialLink({ className, href, children, icon: Icon }) {
  return (
    <li className={clsx(className, 'flex')}>
      <Link
        href={href}
        className="group flex text-sm font-medium text-neutral-800 transition hover:text-blue-500 dark:text-neutral-200 dark:hover:text-blue-400"
      >
...
function Social() {
  return (
    <div className="rounded-lg border border-neutral-100 p-6 dark:border-neutral-700/40">
      <ul role="list">
        <SocialLink href="https://x.com/dougo_chris" icon={TwitterIcon}>
          Follow on Twitter
        </SocialLink>
        <SocialLink
          href="https://www.linkedin.com/in/dougo-chris"
          icon={LinkedInIcon}
          className="mt-4"
        >
          Follow on LinkedIn
          ...
          <div className="lg:pl-20">
            <div className="max-w-xs px-2.5 lg:max-w-none">
              <Image
                ...
                className="aspect-square rotate-3 rounded-lg bg-neutral-100 object-cover dark:bg-neutral-800"
              />
            </div>
          </div>
