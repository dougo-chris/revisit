...
const variantStyles = {
  primary:
    'bg-blue-600 font-semibold text-white hover:bg-blue-500 active:bg-blue-600 active:text-white/70 dark:bg-blue-600 dark:hover:bg-blue-500 dark:active:bg-blue-600 dark:active:text-white/70',
  secondary:
