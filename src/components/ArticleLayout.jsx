        ...
        <div className="xl:relative">
          <div className="max-w-3xl mx-auto">
            {previousPathname && (
              ...
              >
                <ArrowLeftIcon className="w-4 h-4 transition stroke-neutral-500 group-hover:stroke-neutral-700 dark:stroke-neutral-500 dark:group-hover:stroke-neutral-400" />
              </button>
            )}
            <article>
              <header className="flex flex-col">
                <h1 className="mt-6 text-4xl font-bold tracking-tight text-neutral-800 dark:text-neutral-100 sm:text-4xl">
                  {meta.title}
                </h1>
                <time
                  dateTime={meta.date}
                  className="flex items-center order-first text-base text-neutral-400 dark:text-neutral-500"
                >
