          ...
          <div className="mx-auto max-w-3xl">
            ...
            <article>
              <header className="flex flex-col">
                <h1 className="mt-6 text-4xl font-bold tracking-tight text-neutral-800 sm:text-4xl dark:text-neutral-100">
                  {meta.title}
                </h1>
                <time
                  dateTime={meta.date}
