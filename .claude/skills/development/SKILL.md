---
name: development
description: Development guide for the Next.js blog. Use when setting up development environment, building, deploying, or working with the technical architecture. Invoked when user asks about setup, routing, builds, or deployment.
---

# Development Guide

Follow these guidelines for all development work on the Next.js blog.
...
/developer/elixir/YYYY-MM-DD-...    # Individual article
```
