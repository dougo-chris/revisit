...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        blue: {
          500: '#2563EB', // Primary blue (lighter, for links/hover)
          600: '#3843D0', // Primary blue (darker, main accent)
        },
        neutral: {
          50: '#F9FAFB',
          100: '#F3F4F6',
    ...
    typography: (theme) => ({
      ...
      DEFAULT: {
        css: {
          ...
          '--tw-prose-underline': theme('colors.blue.600 / 0.2'),
          '--tw-prose-underline-hover': theme('colors.blue.600'),
          '--tw-prose-bold': theme('colors.neutral.950'),
          '--tw-prose-counters': theme('colors.neutral.950'),
          '--tw-prose-bullets': theme('colors.neutral.950'),
          ...
          '--tw-prose-code-bg': theme('colors.neutral.200 / 0.3'),
          ...
          '--tw-prose-invert-underline': theme('colors.blue.500 / 0.3'),
